                    ...
                    children: [
                      ...
                      imageUrl != ""
                          ? FutureBuilder<String>(
                              future:
                                  storageService.getImageUrlFromS3(imageUrl),
                          ...
                          ElevatedButton(
                              ...
                              onPressed: () async {
                                final result = await Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          UpdateEssentialCareInfoPage(
                                              essentialCareTable:
                                                  _essentialCare[index])),
                                );
                          ...
                          ElevatedButton(
                              ...
                              onPressed: () async {
                                ...
                                if (confirmed ?? false) {
                                  ...
                                  await gql.deleteEssentialCare(
                                      _userid, institutionId);

                                  // Show snackbar after deletion
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                          '$essentialName 항목이 성공적으로 삭제되었습니다.'),
                                    ),
                                  );
                              ...
                              child: Text('삭제', style: buttonTextStyle)),
                          const SizedBox(
                            width: 10,
                          ),
                          ElevatedButton(
                              ...
                              child: Text('추가', style: buttonTextStyle)),
                        ],
                      ),
                    ],
                  )
